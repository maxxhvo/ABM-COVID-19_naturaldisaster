...
public /*strictfp*/ class NetworkTest extends SimState
    ...
    public void start()
        ...
        CustomNode nodes[] = new CustomNode[8];
        ...
        nodes[6] = makeNode( "node6");
        nodes[7] = makeNode( "node7");
        ...
        network.addEdge( nodes[5], nodes[0], "5-0" );
        ...
        network.addEdge( nodes[5], nodes[4], "5-4" );
        network.addEdge( nodes[6], nodes[5], "6-5" );
        network.addEdge( nodes[7], nodes[5], "7-5" );
        network.addEdge( nodes[7], nodes[1], "1-5" );
        network.addEdge( nodes[7], nodes[3], "3-5" );
        }
